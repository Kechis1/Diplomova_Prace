...
public class Main {
    public static void main(String[] args) {
        ...
        String requestQuery = "SELECT * FROM DBO.STUDENT SDT INNER JOIN DBO.STUDUJE SDE ON SDT.SID = SDE.SID INNER JOIN DBO.PREDMET PDT ON SDT.SID = SDE.SID AND SDE.PID = PDT.PID";
